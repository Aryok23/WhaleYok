"""
broksum.py — Scraper broker summary harian via Stockbit.

Sumber: Stockbit (exodus.stockbit.com) — data buy/sell per broker.
...
Catatan: Kode IDX.co.id (legacy) dipindah ke broksum_idx_legacy.py.
  IDX tidak berfungsi di GitHub Actions karena Cloudflare memblokir IP datacenter.

Rate limit: 1.5 detik antar request (wajib).
